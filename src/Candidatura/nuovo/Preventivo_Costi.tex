...
% e i file ausiliari con \input{contenuti/file.tex} senza preoccupazioni
\usepackage{currfile}
\newcommand{\rootdir}{\currfiledir}
\makeatletter
\def\input@path{{\rootdir}{\rootdir contenuti/}}
\makeatother
\usepackage{graphicx}
\graphicspath{{\rootdir}{\rootdir contenuti/}{\rootdir contenuti/immagini/}}
