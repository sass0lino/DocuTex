...
\usepackage{currfile}
\usepackage{graphicx}
\let\rootpath\currfiledir
\graphicspath{{\rootpath}{\rootpath contenuti/}{\rootpath contenuti/immagini/}{\rootpath ../../assets/immagini/}}
...
\input{\rootpath contenuti/intestazione_titolo.tex}
