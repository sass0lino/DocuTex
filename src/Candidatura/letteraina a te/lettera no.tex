...
\usepackage{titling} % primo commento 
...
\usepackage{ragged2e} % Paccheifica il testo di tabelle
...
\newpage
\input{contenuti/resoconto_incontro.tex}
\vspace{1cm}
