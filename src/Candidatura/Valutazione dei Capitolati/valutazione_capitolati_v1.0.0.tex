...
\usepackage{graphicx} % Reting images
...
\usepackage{xcolor} % Per co
\usepackage{colortbl} % Per colorare le celle delle tabelle
\usepackage{lipsum} % Per generare lorem ipsum
\usepackage[normalem]{ulem} % Per sottotesto
\usepackage{array} % Per la vi fluttuante drisposte
...
\setlength{\parindent}{0pt} % Rco dei paragrafi
